...
class ExpenseCategory extends Model {
  ...
  const ExpenseCategory._internal(
      {required this.id, required categoryname, Expenses, createdAt, updatedAt})
  ...
  factory ExpenseCategory(
      {String? id, required String categoryname, List<ExpenseItem>? Expenses}) {
    return ExpenseCategory._internal(
        id: id == null ? UUID.getUUID() : id,
        categoryname: categoryname,
        Expenses: Expenses != null
            ? List<ExpenseItem>.unmodifiable(Expenses)
            : Expenses);
  }
  ...
  ExpenseCategory copyWith(
      {String? id, String? categoryname, List<ExpenseItem>? Expenses}) {
    return ExpenseCategory._internal(
        id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'Expenses': _Expenses?.map((ExpenseItem? e) => e?.toJson()).toList(),
