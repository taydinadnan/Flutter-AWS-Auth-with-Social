...
class ExpenseItem extends Model {
  ...
  const ExpenseItem._internal(
      {required this.id,
      required expensename,
      required expensevalue,
      required expensecategory,
      required createdAt,
      updatedAt})
  ...
  String toString() {
    ...
    buffer.write("expensevalue=" +
        (_expensevalue != null ? _expensevalue!.toString() : "null") +
        ", ");
    buffer.write("expensecategory=" +
        (_expensecategory != null ? _expensecategory!.toString() : "null") +
        ", ");
  ...
  ExpenseItem.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _expensecategory = json['expensecategory']?['serializedData'] != null
            ? ExpenseCategory.fromJson(new Map<String, dynamic>.from(
                json['expensecategory']['serializedData']))
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'expensevalue': _expensevalue,
        'expensecategory': _expensecategory?.toJson(),
